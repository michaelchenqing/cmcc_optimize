 ...
 * 
 * @author gaoqs
 * @date 2014年6月27日 下午2:39:40
 */
public class Paginator implements Serializable, Cloneable {

    private static final long serialVersionUID = 5467023719704868864L;
    ...
    public static boolean isControlOverPage = false;// 不控制查询分页超页
     ...
     */
    public int getPages() {
//        if(!isControlOverPage){
//            //不做分页处理
//            return (int) (items / itemsPerPage);
//        }
...
//        }
        ...
        if (pages > 0) {
            return (page < 1) ? 1 : ((page > pages && isControlOverPage) ? pages : page);
        }
