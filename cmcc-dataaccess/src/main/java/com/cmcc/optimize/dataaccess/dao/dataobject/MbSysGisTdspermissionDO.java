...
/**
 * A data object class directly models database table <tt>MB_SYS_GIS_TDSPERMISSION</tt>.
 *
 *
 * @author gaoqs
 */
public class MbSysGisTdspermissionDO {
	...
	/**
	 * This property corresponds to db column <tt>RNCID</tt>.
	 */
