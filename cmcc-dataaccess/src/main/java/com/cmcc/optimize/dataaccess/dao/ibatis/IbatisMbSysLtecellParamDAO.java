...
import com.cmcc.optimize.dataaccess.dao.daointerface.MbSysLtecellParamDAO;
...
/**
 * An ibatis based implementation of dao interface <tt>com.cmcc.optimize.dataaccess.dao.daointerface.MbSysLtecellParamDAO</tt>.
 *
 *
 * @author gaoqs
 */
public class IbatisMbSysLtecellParamDAO extends SqlMapClientDaoSupport implements MbSysLtecellParamDAO {
	/**
    ...
    public MbSysLtecellParamDO getLtecellParamBycellId(String cellGlbId) throws DataAccessException {
        ...
        return (MbSysLtecellParamDO) getSqlMapClientTemplate().queryForObject("MS-MB-SYS-LTECELL-PARAM-GET-LTECELL-PARAM-BYCELL-ID", cellGlbId);
    ...
    public String insertLtecellParam(MbSysLtecellParamDO mbSysLtecellParam) throws DataAccessException {
    	if (mbSysLtecellParam == null) {
    		throw new IllegalArgumentException("Can't insert a null data object into db.");
    	}
    	
        getSqlMapClientTemplate().insert("MS-MB-SYS-LTECELL-PARAM-INSERT-LTECELL-PARAM", mbSysLtecellParam);

        return mbSysLtecellParam.getCellGlbId();
    }
    ...
    public int updateLtecellParam(MbSysLtecellParamDO mbSysLtecellParam) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-MB-SYS-LTECELL-PARAM-UPDATE-LTECELL-PARAM", mbSysLtecellParam);
    }
    ...
    public int deleteLtecellParam(String cellGlbId) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().delete("MS-MB-SYS-LTECELL-PARAM-DELETE-LTECELL-PARAM", cellGlbId);
    }
