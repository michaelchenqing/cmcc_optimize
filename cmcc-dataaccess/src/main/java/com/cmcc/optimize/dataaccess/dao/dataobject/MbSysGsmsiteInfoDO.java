...
/**
 * A data object class directly models database table <tt>MB_SYS_GSMSITE_INFO</tt>.
 *
 *
 * @author gaoqs
 */
public class MbSysGsmsiteInfoDO {
    private static final long serialVersionUID = 741231858441822688L;

    //========== properties ==========

	/**
	 * This property corresponds to db column <tt>BSC_ID</tt>.
	 */
    ...
    /**
     * Getter method for property <tt>bscId</tt>.
     *
     * @return property value of bscId
     */
	...
	/**
	 * Setter method for property <tt>bscId</tt>.
	 * 
	 * @param bscId value to be assigned to property bscId
     */
